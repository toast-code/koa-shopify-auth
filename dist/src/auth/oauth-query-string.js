...
function oAuthQueryString(ctx, options, callbackPath) {
    ...
    var redirectHost = options.redirectHost, _a = options.scopes, scopes = _a === void 0 ? [] : _a, apiKey = options.apiKey, accessMode = options.accessMode;
    ...
    var redirectParams = {
        ...
        scope: scopes.join(', '),
        client_id: apiKey,
        redirect_uri: "https://" + (redirectHost ? redirectHost : host) + callbackPath,
    };
